...
class RepetitionController extends Controller
{
    ...
    public function sondages(Repetition $repetition)
    {
        $repetition->load(['sondages.user']);
        $sondages = $repetition->sondages;
        return view('admin.suivi.repetitions.sondages', compact('repetition', 'sondages'));
    }
}
