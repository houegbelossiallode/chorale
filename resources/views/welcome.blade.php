...
@section('content')
    ...
    <header class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <div
                class="w-full h-full bg-[url('https://images.unsplash.com/photo-1507838153414-b4b713384a76?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center bg-fixed scale-110">
            </div>
        ...
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-amber-500/10 rounded-full animate-spin-slow z-10">
        </div>
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-white/5 rounded-full animate-spin-slow z-10"
            style="animation-direction: reverse; animation-duration: 40s;"></div>
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] border border-amber-400/5 rounded-full animate-spin-slow z-10"
            style="animation-duration: 50s;"></div>

        <!-- Floating particles -->
        <div class="absolute top-20 left-[15%] w-2 h-2 bg-amber-400/30 rounded-full animate-float"
            style="animation-delay: 0s;"></div>
        <div class="absolute top-40 right-[20%] w-1.5 h-1.5 bg-amber-300/20 rounded-full animate-float"
            style="animation-delay: 2s;"></div>
        <div class="absolute bottom-40 left-[30%] w-1 h-1 bg-white/20 rounded-full animate-float-slow"
            style="animation-delay: 1s;"></div>
        <div class="absolute top-60 right-[35%] w-2.5 h-2.5 bg-amber-500/15 rounded-full animate-float-slow"
        ...
        <div class="relative z-20 text-center px-4 max-w-5xl mx-auto pt-24 md:pt-20">
            ...
            <h1
                class="text-5xl sm:text-7xl md:text-[8rem] lg:text-[10rem] font-serif text-white mb-4 leading-[0.85] tracking-tight">
                <span class="text-white/50 italic font-light text-4xl sm:text-6xl md:text-8xl">Chorale</span> </br> Saint
                Oscar<br>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-5 gap-20 items-center">
                ...
                <div class="lg:col-span-2 reveal-left">
                    <div class="relative">
                        <div
                            class="aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-2xl shadow-amber-900/10 ring-1 ring-black/5">
                            @if($priest_word && $priest_word->image_path)
                                <img src="{{ $priest_word->image_path }}" class="w-full h-full object-cover"
                                    alt="Parole spirituelle">
                            @else
                                <div
                                    class="w-full h-full bg-gradient-to-br from-amber-100 via-amber-50 to-orange-50 flex items-center justify-center">
                                    <div class="text-center">
                                        <div
                                            class="w-24 h-24 mx-auto bg-gradient-to-br from-amber-200 to-amber-300 rounded-3xl flex items-center justify-center mb-4 animate-float-slow">
                        ...
                        <!-- Decorative frame -->
                        <div
                            class="absolute -bottom-6 -right-6 w-full h-full rounded-[2.5rem] border-2 border-amber-300/20 -z-10">
                        </div>
                        <!-- Floating badge -->
                        <div
                            class="absolute -top-4 -right-4 bg-gradient-to-br from-amber-500 to-yellow-500 text-white px-5 py-3 rounded-2xl shadow-xl shadow-amber-500/30 animate-float-slow font-bold text-sm">
                            ✦ Méditation
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-3 reveal-right">
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200/50 mb-8">
                    ...
                    <blockquote class="relative">
                        <div class="absolute -top-3 -left-1 text-8xl font-serif text-amber-200/50 leading-none select-none">
                            "</div>
                        <p class="text-xl md:text-2xl text-gray-600 leading-relaxed font-elegant italic relative z-10 pl-8 border-l-4 border-gradient-gold"
                            style="border-image: linear-gradient(to bottom, #c9a84c, #e8d48b) 1;">
                            @if($priest_word)
                                {!! $priest_word->content !!}
                            @else
                                La musique sacrée est le pont entre le visible et l'invisible. Elle élève nos prières jusqu'au
                                trône de Dieu et fait descendre Sa grâce dans nos cœurs. Notre chorale est cet instrument divin.
                            @endif
                        </p>
                        @if($priest_word)
                    ...
                    <div class="mt-14">
                        <a href="{{ route('about') }}"
                            class="inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white rounded-2xl font-semibold hover:bg-gray-800 transition-all duration-300 hover:shadow-xl hover:shadow-gray-900/20 group">
    ...
    <section class="py-24 bg-white relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative rounded-[3rem] overflow-hidden bg-gray-900 shadow-2xl shadow-amber-900/20 reveal">
                ...
                <div
                    class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-amber-500/10 to-transparent rounded-full blur-3xl">
                </div>
                <div
                    class="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-purple-500/10 to-transparent rounded-full blur-3xl">
                </div>
                ...
                <div class="relative z-10 grid lg:grid-cols-2 gap-12 items-center p-8 md:p-16 lg:p-20">
                    <div class="reveal-left">
                        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8">
                            <span class="text-xs font-bold text-amber-400 uppercase tracking-[0.3em]">✦ Recrutement
                                Ouvert</span>
                        </div>
                        ...
                        <p class="text-white/60 text-lg leading-relaxed mb-10 font-elegant italic">
                            ...
                            <strong>Rendez-vous sur notre page contact pour nous laisser un message, et nous reviendrons
                                vers vous très prochainement.</strong>
                        </p>

                        <div class="space-y-4 mb-10">
                            <div class="flex items-center gap-4 text-white/80">
                                <div
                                    class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-amber-500">
                        ...
                        <a href="{{ route('contact') }}"
                            class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-2xl font-bold hover:shadow-2xl hover:shadow-amber-500/30 transition-all duration-300 hover:scale-105 group">
                            Rejoindre la Chorale
                    ...
                    <div class="reveal-right hidden lg:block">
                        <div class="relative">
                            ...
                            <div class="absolute -bottom-10 -left-10 w-24 h-24 bg-purple-500/20 rounded-full blur-2xl">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-32 bg-white relative overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-amber-400/40 to-transparent">
        </div>
        <!-- Background decoration -->
        <div
        ...
        <div
            class="absolute bottom-20 left-0 w-96 h-96 bg-gradient-to-tr from-purple-100/20 to-transparent rounded-full blur-3xl">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-6 reveal">
                <div>
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200/50 mb-6">
                        <span class="text-xs font-bold text-amber-700 uppercase tracking-[0.3em]">✦ Prochaines Dates</span>
                    </div>
                    <h2 class="text-4xl md:text-6xl font-serif text-gray-900 leading-[1.1]">Agenda<br><span
                            class="text-gradient-gold">Liturgique</span></h2>
                </div>
                <a href="{{ route('events') }}"
                    class="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-xl font-semibold text-sm hover:bg-gray-800 transition-all group shrink-0">
                    Tout l'agenda
            ...
            <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="group card-premium bg-white rounded-3xl overflow-hidden border border-gray-100 reveal flex flex-col h-full"
                        ...
                        <div class="aspect-[16/9] overflow-hidden relative">
                            ...
                            <div class="absolute top-4 left-4">
                                <span
                                    class="px-3 py-1.5 rounded-xl bg-white/90 backdrop-blur-sm text-[#7367F0] text-[10px] font-bold uppercase tracking-wider shadow-sm border border-white/20">
                                    {{ $event->type->libelle }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            <div class="flex items-center gap-4 mb-6">
                                <!-- Premium Date Badge -->
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-amber-500 via-yellow-500 to-amber-600 rounded-2xl flex flex-col items-center justify-center shadow-lg shadow-amber-500/20 group-hover:scale-110 transition-transform duration-500 shrink-0">
                                    <span
                                ...
                                <div>
                                    <p class="text-sm font-bold text-gray-900 capitalize">
                                        {{ $event->start_at->translatedFormat('l') }}</p>
                            ...
                            <h3
                                ...
                                {{ $event->title }}</h3>
                            <div class="text-gray-400 text-sm mb-8 line-clamp-2 leading-relaxed flex-1 prose prose-sm max-w-none">
                            ...
                            <div class="flex items-center justify-between pt-6 border-t border-gray-50">
                                ...
                                <a href="{{ route('evenements.show', $event->id) }}"
                                    class="w-10 h-10 rounded-xl flex items-center justify-center text-gray-400 group-hover:bg-gradient-to-br group-hover:from-amber-500 group-hover:to-amber-600 group-hover:text-white transition-all duration-300 group-hover:shadow-lg group-hover:shadow-amber-500/20">
                ...
                @empty
                    <div class="col-span-full py-12 text-center text-gray-400 italic">Aucun événement à venir pour le moment.
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="py-20 md:py-32 bg-dark-purple relative overflow-hidden">
        ...
        <div
            class="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-amber-500/5 to-purple-500/5 blur-3xl">
        </div>
        <div class="absolute top-20 left-20 w-32 h-32 border border-amber-500/10 rounded-full animate-spin-slow"></div>
        <div class="absolute bottom-20 right-20 w-48 h-48 border border-white/5 rounded-full animate-spin-slow"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-20 reveal">
                ...
                <h2 class="text-4xl md:text-6xl font-serif text-white leading-[1.1]">Témoignages<br><span
                        class="text-gradient-gold">de Foi</span></h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                @forelse($testimonies as $i => $t)
                    <div class="glass rounded-3xl p-6 sm:p-8 hover:bg-white/10 transition-all duration-500 card-premium reveal"
                        style="transition-delay: {{ $i * 100 }}ms;">
                        <div class="flex items-center gap-4 mb-6">
                            @if($t->image_path)
                                <img src="{{ $t->image_path }}"
                                    class="w-12 h-12 rounded-2xl object-cover shadow-lg shadow-amber-500/20" alt="{{ $t->author }}">
                            @else
                                <div
                                    class="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-amber-500/20">
                                    {{ substr($t->author ?? 'T', 0, 1) }}</div>
                            @endif
                            <div>
                        ...
                        <p class="text-white/50 leading-relaxed font-elegant italic text-lg line-clamp-4">
                            "{{ Str::limit($t->content, 150) }}"</p>
                    </div>
                @empty
                    <div class="col-span-full py-12 text-center text-white/30 italic">Aucun témoignage partagé pour le moment.
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="py-32 bg-cream relative bg-pattern">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20 reveal">
                ...
                <h2 class="text-5xl md:text-6xl font-serif text-gray-900 leading-[1.1]">Dernières<br><span
                        class="text-gradient-gold">Nouvelles</span></h2>
            </div>

            <div class="grid md:grid-cols-3 gap-10">
                @forelse($latest_news as $i => $p)
                    <article class="group card-premium bg-white rounded-3xl overflow-hidden border border-gray-100 reveal"
                        style="transition-delay: {{ $i * 100 }}ms;">
                        ...
                        <div class="p-8">
                            <span
                                class="text-amber-600 font-bold text-xs uppercase tracking-widest block mb-4">{{ $p->published_at ? $p->published_at->diffForHumans() : $p->created_at->diffForHumans() }}</span>
                            <h3
                                class="text-xl font-serif font-bold text-gray-900 group-hover:text-amber-700 transition mb-4 leading-tight">
                                {{ $p->title }}</h3>
                            <div class="text-gray-400 text-sm line-clamp-3 leading-relaxed prose prose-sm max-w-none">
                                {!! $p->content !!}</div>
                        </div>
                    </article>
                @empty
    ...
    <section class="py-32 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                ...
                <h2 class="text-5xl md:text-6xl font-serif text-gray-900 leading-[1.1]">Nos<br><span
                        class="text-gradient-gold">Voix</span></h2>
                <p class="text-gray-400 mt-6 max-w-lg mx-auto text-sm leading-relaxed">Les visages et les voix qui font
                    battre le cœur de notre paroisse</p>
            </div>

            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-5 mb-14 reveal">
                @foreach($members_preview as $i => $member)
                    <a href="{{ route('profile.show', $member->slug) }}" class="group cursor-pointer"
                        style="transition-delay: {{ $i * 80 }}ms;">
                        <div
                            class="aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-amber-50 to-amber-100 flex items-center justify-center group-hover:shadow-xl group-hover:shadow-amber-500/10 transition-all duration-500 group-hover:-translate-y-2 border border-amber-100 group-hover:border-amber-300">
                            @if($member->photo_url)
                            ...
                            @else
                                <div
                                    class="w-14 h-14 bg-gradient-to-br from-amber-200 to-amber-300 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
            ...
            <div class="text-center reveal">
                <a href="{{ route('members') }}"
                    class="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-white rounded-2xl font-bold hover:shadow-2xl hover:shadow-amber-500/30 transition-all duration-500 hover:scale-105 group">
    ...
    <section class="relative py-32 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-amber-600 via-amber-700 to-amber-900 animate-gradient-flow">
        </div>
        <div
            class="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1542621334-a25bb769435b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center bg-fixed">
        </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center reveal">
            ...
            <p class="text-lg text-white/50 mb-14 max-w-xl mx-auto leading-relaxed">
                Votre soutien nous permet d'acquérir de nouveaux instruments, de former nos membres et d'assurer le
                rayonnement de notre ministère musical.
            </p>
            <a href="{{ route('donation') }}"
                class="inline-flex items-center gap-3 px-12 py-6 bg-white text-amber-800 rounded-2xl font-extrabold text-lg hover:bg-amber-50 transition-all duration-500 shadow-2xl shadow-black/20 hover:scale-105 hover:shadow-3xl group">
