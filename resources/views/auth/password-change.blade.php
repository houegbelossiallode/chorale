...
@section('title', 'Sécurité du compte — ' . config('app.name'))
@section('navDark', '1')
@section('hideAuthActions', '1')
                    ...
                    <div class="relative">
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <span class="text-white/40 text-xs font-bold uppercase tracking-[0.3em]">Protection</span>
                            </div>

                            <!-- Quote -->
                            <div class="relative z-10">
                                <div class="text-6xl font-serif text-amber-500/20 leading-none mb-4">"</div>
                                <p class="text-2xl font-elegant italic text-white/70 leading-relaxed mb-6">La sécurité de
                                    votre compte est notre priorité pour cette première connexion.</p>
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-px bg-gradient-to-r from-amber-500 to-transparent"></div>
                                    <span class="text-amber-400/60 text-xs font-bold uppercase tracking-[0.25em]">ESPACE
                                        MEMBRE</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="reveal-right">
                    <div class="max-w-md mx-auto">
                        <div class="text-center mb-10">
                            ...
                            <h1 class="text-4xl font-serif font-bold text-gray-900 mb-3">Sécurisez votre accès ✦</h1>
                            <p class="text-gray-400 text-sm">Pour votre première connexion, veuillez définir un mot de passe
                                personnel.</p>
                        </div>
                        ...
                        <!-- <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="text-sm font-bold text-gray-400 hover:text-amber-500 transition-colors flex items-center justify-center gap-2 mx-auto group">
                                    <svg class="w-4 h-4 group-hover:-translate-x-1 transition" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
