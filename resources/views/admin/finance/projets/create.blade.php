...
<div class="w-full">
    <div class="mb-8">
        <a href="{{ route('admin.projets.index') }}" class="text-sm text-[#7367F0] flex items-center gap-2 mb-2 hover:underline">
    ...
    <form action="{{ route('admin.projets.store') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-material overflow-hidden">
            ...
            <div class="p-8 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                <a href="{{ route('admin.projets.index') }}" class="px-6 py-2.5 rounded-lg text-slate-600 font-medium hover:bg-slate-200 transition-all">Annuler</a>
