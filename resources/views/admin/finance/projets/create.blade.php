                ...
                <div class="p-8 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title"
                            class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-[#7367F0] outline-none transition-all"
                            placeholder="Ex: Achat d'un nouveau clavier" required>
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-3 uppercase tracking-widest">Objectif
                            Financier (€)</label>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-[#7367F0] outline-none transition-all resize-none"
                            placeholder="Expliquez l'importance de ce projet..."></textarea>
                    </div>
                </div>
