...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button onclick="window.location.href='{{ route('admin.projets.create') }}'" class="btn-primary flex items-center gap-2">
        ...
        <div class="bg-white rounded-xl shadow-material p-6 border border-transparent hover:border-[#7367F0]/30 transition-all flex flex-col justify-between">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-slate-50">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.projets.edit', $projet->id) }}" class="p-2 text-slate-400 hover:text-[#7367F0] transition-colors">
