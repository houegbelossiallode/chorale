    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-material p-4 flex flex-col md:flex-row justify-between gap-4">
            <form action="{{ route('admin.finance.transactions.index') }}" method="GET"
                ...
                <select name="type"
                    class="px-4 py-2 rounded-lg border border-slate-200 text-sm outline-none focus:border-[#7367F0]">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.finance.export.csv') }}" class="btn-secondary flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.finance.report.pdf') }}" target="_blank"
                    class="btn-secondary flex items-center gap-2 bg-red-50 text-red-600 border-red-100 hover:bg-red-100">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
