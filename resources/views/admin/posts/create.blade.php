    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-xl sm:text-2xl font-semibold text-[#444050]">Rédiger un Article</h3>
                    <p class="text-[13px] text-slate-400">Partagez les actualités de la chorale</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="card-material p-6 sm:p-8 space-y-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" required
                                ...
                                placeholder="Ex: Retour sur le concert de Noël">
                        ...
                        <!-- <div class="space-y-1.5">
                            ...
                            <textarea name="excerpt" rows="2"
                                ...
                                placeholder="Une brève introduction qui incitera à lire la suite...">{{ old('excerpt') }}</textarea>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <textarea name="content" rows="12" required
                                ...
                                placeholder="Racontez votre histoire ici...">{{ old('content') }}</textarea>
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                ...
                                <select name="category" required
                                    ...
                                    <option value="testimony" {{ old('category') == 'testimony' ? 'selected' : '' }}>
                                        Témoignage</option>
                                    <option value="priest_word" {{ old('category') == 'priest_word' ? 'selected' : '' }}>
                                        Parole de Prêtre</option>
                                    <option value="history" {{ old('category') == 'history' ? 'selected' : '' }}>Histoire
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="pt-2">
                                <label class="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <span
                                        class="text-[14px] font-medium text-slate-600 group-hover:text-[#444050] transition-colors">Publier
                                        l'article</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <!-- Featured Image -->
                    <div class="card-material p-6 sm:p-8 space-y-6" x-data="{ imageUrl: null }">
                        <div class="flex items-center gap-2 pb-2 border-b border-slate-50">
                        ...
                        <div class="space-y-4">
                            <div class="relative group">
                                ...
                                <template x-if="!imageUrl">
                                    <label for="image_path"
                                        ...
                                        <span class="text-[12px] font-medium text-slate-500">Choisir une image</span>
                                        <span class="text-[10px] text-slate-400 mt-1">PNG, JPG jusqu'à 2MB</span>
                                    </label>
                                </template>
                            ...
                            @error('image_path') <p class="text-xs text-[#EA5455] text-center">{{ $message }}</p> @enderror
                        </div>
                    </div>
