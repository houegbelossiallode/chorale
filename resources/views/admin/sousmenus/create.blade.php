...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center gap-3 mb-2">
            <a href="{{ route('admin.sousmenus.index') }}"
        ...
        <form action="{{ route('admin.sousmenus.store') }}" method="POST"
            ...
            <div class="p-8 space-y-6">
                <div class="space-y-1.5">
                    ...
                    <select name="menu_id" required
                        ...
                        @foreach($menus as $menu)
                            <option value="{{ $menu->id }}" {{ old('menu_id') == $menu->id ? 'selected' : '' }}>{{ $menu->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="url" value="{{ old('url') }}" required
                        ...
                        placeholder="Ex: /admin/finance/factures">
