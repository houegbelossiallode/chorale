...
@section('content')
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 sm:mb-8">
            ...
            <div class="grid grid-cols-2 md:flex items-center gap-2 sm:gap-3">
                ...
                <a href="{{ route('admin.finance.report.pdf') }}" target="_blank"
                    class="btn-secondary gap-2 border border-slate-100 bg-red-50/50 text-red-600 hover:bg-red-50">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="card-material p-4 md:p-5">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 md:w-12 md:h-12 bg-[#E7E7FF] text-[#7367F0] rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-[10px] md:text-[11px] font-semibold text-[#28C76F] bg-[#DFF7E9] px-1 py-0.5 rounded">+12%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-material p-4 md:p-5">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 md:w-12 md:h-12 bg-[#DFF7E9] text-[#28C76F] rounded-lg flex items-center justify-center shrink-0">
                        <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-[10px] md:text-[11px] font-semibold text-[#28C76F] bg-[#DFF7E9] px-1 py-0.5 rounded">Top</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-material p-4 md:p-5">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 md:w-12 md:h-12 bg-[#FFF1E3] text-[#FF9F43] rounded-lg flex items-center justify-center shrink-0">
                        <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="card-material p-4 md:p-5">
                <div class="flex items-center gap-4">
                    <div
                        class="w-10 h-10 md:w-12 md:h-12 bg-[#E5F8FF] text-[#00CFE8] rounded-lg flex items-center justify-center shrink-0">
                        <svg class="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="min-w-0">
                        <p class="text-[12px] md:text-[13px] text-slate-500 font-medium truncate">Solde Global</p>
                        <div class="flex items-center gap-2">
                            <span
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div class="card-material p-4 flex items-center justify-between border-l-4 border-[#EA5455]">
                <div>
            ...
            <div class="card-material lg:col-span-2 overflow-hidden flex flex-col">
                <div class="px-3 py-4 sm:px-6 border-b border-slate-100 flex items-center justify-between shrink-0">
                    ...
                    <a href="{{ route('admin.members.index') }}"
                        class="text-[11px] sm:text-[13px] text-[#7367F0] font-medium hover:underline">Voir tout</a>
                </div>
                                    ...
                                    <td class="px-3 sm:px-6 py-3">
                                        <div class="flex items-center gap-2 sm:gap-3">
                                            <img src="{{ $member->photo_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($member->first_name) . '&background=f8f7fa&color=7367f0&size=100' }}"
                                                class="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-white shadow-sm shrink-0 object-cover">
                                            <div class="min-w-0">
                                                <p class="text-[12px] sm:text-[14px] font-semibold text-[#444050] truncate">
            ...
            <div class="space-y-6">
                <div class="card-material p-5 sm:p-6 bg-gradient-to-br from-[#7367F0] to-[#9E95F5] text-white">
                    <div class="flex justify-between items-start mb-6 md:mb-10">
                        <div>
                            <p
                                class="text-white/80 text-[11px] sm:text-[13px] uppercase font-bold tracking-widest mb-1 sm:mb-2">
                                Prochain Temps Fort</p>
                            ...
                            <h2 class="text-xl sm:text-2xl font-bold leading-tight">
                                {{ $nextEvent->title ?? 'Aucun événement' }}</h2>
                        </div>
                        <div
                            class="w-9 h-9 sm:w-10 sm:h-10 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-md shrink-0">
                    ...
                    @if($nextEvent)
                        <div class="space-y-3 sm:space-y-4 mb-6">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-7 h-7 sm:w-8 sm:h-8 bg-white/10 rounded-full flex items-center justify-center shrink-0">
                                ...
                                <span
                                    class="text-[13px] sm:text-[14px] font-medium">{{ $nextEvent->start_at->translatedFormat('d M \à H:i') }}</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-7 h-7 sm:w-8 sm:h-8 bg-white/10 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <button
                            class="w-full py-2 sm:py-2.5 bg-white text-[#7367F0] font-bold text-[12px] sm:text-[13px] rounded-lg shadow-lg hover:shadow-xl transition-all border border-[#7367F0]/20">
                            Vérifier
                        </button>
                    @endif
                </div>
